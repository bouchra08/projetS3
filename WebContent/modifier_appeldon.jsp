    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
               <img class="main-logo" src="images/mainlogo.png" alt="" /></a>
                ...
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="Departments List" href="#"><span class="mini-sub-pro">Lister appels aux dons</span></a></li>
                        ...
                        <li id="removable">
                            ...
                            <ul class="submenu-angle page-mini-nb-dp" aria-expanded="false">
                                <li><a title="Login" href="login.html"><span class="mini-sub-pro">Modifier profil</span></a></li>
                                <li><a title="Password Recovery" href="password-recovery.html"><span class="mini-sub-pro">Modifier password</span></a></li>                                
                                <li><a title="Lock" href="lock.html"><span class="mini-sub-pro">Deconnexion</span></a></li>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Ajouter appel au don</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a href="#description">Details appel au don</a></li>
                            </ul>
                                                    ...
                                                    <form action="AppelaudonServlet" method="POST" class="dropzone dropzone-custom needsclick addcourse" id="demo1-upload">
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                ...
                                                                <div class="form-group">
                                                                    <input name="nom" type="text" class="form-control" value="${ap.nom}">
                                                                </div>
                                                                <div class="form-group">
                                                                ...
                                                                <!-- <div class="form-group alert-up-pd">
                                                                    <div class="dz-message needsclick download-custom">
                                                                        ...
                                                                        <input type="file" name="image" class="hd-pro-img"  />
                                                                    </div>
                                                                </div> --> 
                                                            </div>
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <div class="form-group">
                                                                    <input name="budget" type="text" class="form-control" value="${ap.budget}">
                                                                </div>
                                                                <div class="form-group">
                                                                	 <input name="description" type="text" class="form-control" value="${ap.description}"></input>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-12">
                                                                <div class="payment-adress">
                                                                    <button value="ModifierAppelaudon" name="modifierappelaudon" type="submit" class="btn btn-primary waves-effect waves-light">Submit</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </form>
