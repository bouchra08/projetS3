                    ...
                    <ul class="metismenu" id="menu1">
                        ...
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                ...
                                <li>
		                        <form action="ProjetServlet" method="POST">
		            			&emsp;<button value="AjoutProjet" name="ajoutProjet" type="submit" data-toggle="tooltip" title="" style="background:transparent;color:grey;border: none;width:150px;height:50px;font-size: 17px;">Ajouter projet</button>
		       					 </form>
		       					</li>
                         ...
                         <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                               ...
                               <li>
		                        <form action="AppelaudonServlet" method="POST">
		            			&emsp;&emsp;<button value="AjoutAppelaudon" name="AjoutAppelaudon" type="submit" data-toggle="tooltip" title="" style="background:transparent;color:grey;border: none;width:150px;height:50px;font-size: 17px;">Ajouter appel </button>
		       					 </form>
		       					</li>
                            </ul>
                        </li>
                        ...
                        <li>
                        <form action="DonateurServlet" method="POST">
            			&emsp;<span class="educate-icon educate-data-table icon-wrap" aria-hidden="true"></span><button value="AfficherDonateur" name="afficherDonateur" type="submit" data-toggle="tooltip" title="" style="background:transparent;color:grey;border: none;width:100px;height:50px;font-size: 17px;">Liste Dons</button>
       					 </form>
       					</li>
