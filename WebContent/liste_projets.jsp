                    ...
                    <ul class="metismenu" id="menu1">
                        ...
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="#" href="#"><span class="mini-sub-pro">Lister projets</span></a></li>
                                <li><a title="#" href="add_project.jsp"><span class="mini-sub-pro">Ajouter projet</span></a></li>
                            ...
                            <div class="asset-inner">
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                             <a href="modifier_projet.jsp?id_projet=${p.id_projet}"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
